...
public class ChatServer implements Runnable {
	...
	private final ByteBuffer welcomeBuf = ByteBuffer.wrap(
			("Bem vindo ao Chat do trabalho de Redes use /help para instruções!" + ";;;" + UtilC.serverMessageColor)
					.getBytes());
	...
	private void handleRead(SelectionKey key) throws IOException {
		...
		Message m = UtilC.deserialize(msg);
		try {
	...
	public static void main(String[] args) throws IOException {
		ChatServer server = new ChatServer(10523);
